...
/**
 * Product category (as disease group) query. Returns the main product categories and their subgroups (as disease subgroup) in order productCategoryName(default) or productCategoryId
 * @param {enum|null} @options= "code"|"name" {"order": "code"}
 */
...
getCategoryMethod.prototype.execute = function(params) {
