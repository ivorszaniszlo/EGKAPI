 ...
 * @param {String|null} {"molecule_name": ""} required
...
fullTextSearchMethod.prototype.execute = function(params) {
    console.info('Executing getDataMethod, params:', params);
        ...
        if(medicine_name || molecule_name){
            if (medicine_name && !molecule_name) {
                path = path + '&q=' + medicine_name;
            }
            else if (molecule_name && !medicine_name) {
                path = path + '&molecule_name=' + molecule_name;
            }
            else if (molecule_name && medicine_name) {
                path = path + '&q=' + medicine_name + '&molecule_name=' + molecule_name;
            }
            ...
            //get here the HttpProvider statusCode
                try{
                    ...
                    if (statusCode === 200){
                        ...
                        that._dispatchError(param, -32602, 'Invalid params: Not found');
                    }
                    else 
